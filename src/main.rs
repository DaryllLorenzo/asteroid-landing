                ...
                <main>
                    ...
                    <section id="downloads" class="downloads">
                        <div class="section-inner">
                            ...
                            <p class="section-sub fade-up" style="transition-delay: 60ms;">
                                {"v0.4.0 — Windows, Linux y macOS"}
                            </p>
                            <div class="download-grid">
                                <a href="https://github.com/DaryllLorenzo/Asteroid/releases/download/v0.4.0/asteroid_0.4.0.exe"
                                ...
                                <a href="https://github.com/DaryllLorenzo/Asteroid/releases/download/v0.4.0/asteroid_0.4.0_amd64.deb"
                                   class="download-card fade-up"
                                ...
                                <a href="https://github.com/DaryllLorenzo/Asteroid/releases/download/v0.4.0/asteroid_0.4.0.app.zip"
                                   class="download-card fade-up"
